      <svg 
        ...
        style="isolation:isolate; width:32px; height: 32px;"
        viewBox="0 0 1000 1000"
        width="1000pt"
        height="1000pt">
        <defs>
          <clipPath id="_clipPath_dWZOaLxWThweJRFapPkZLw56WEmth5Xh">
            <rect width="1000" height="1000" />
          </clipPath>
        </defs>
        <g clip-path="url(#_clipPath_dWZOaLxWThweJRFapPkZLw56WEmth5Xh)">
          <linearGradient
            id="_lgradient_0"
